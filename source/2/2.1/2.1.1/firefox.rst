...
When you are downloading something a circle will show up showing progress of the download. The more shown in blue the more of the file has been downloaded. To view what you are downoloading press the left click the circled graph showing what you have downloaded. Then you can see how much data has been downloaded in numbers and how big a file it is and a bar graph of the status of different files downloading. To pause downloading a file right click and select :menuselection:`Pause`. To then continue downloading again right click and select :menuselection:`Resume`.
