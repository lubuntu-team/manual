...
To add a shadow to your shape use the :guilabel:`Shadow` tab. To use shadow check the :guilabel:`Use Shadow` checkbox. To view your shape use the :guilabel:`Preview` on the right side. To choose what side your shadow is on click the corner you want the shadow to be on. To choose the color of your shadow use the color field.
