...
The :guilabel:`level is low at` changes when the battery is considered low power. The checkbox :guilabel:`Show icon` shows an icon in the tray for your power management.  
