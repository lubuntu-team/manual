...
To change font color press the button that has a T with a drop on it and a red underline this will bring down several differenent colors you can change your text to a color you want. You can also change your font color threought the :guilabel:`Format --> Character` window.
