...
If you want a second copy of a pdf open you can right click on the tabbar :menuselection:`Open Copy in new tab`. If you want a second copy of a pdf in a new window right click the tab bar :menuselection:`Open Copy in new window`. To open a file manager in the location of file right click on the tab bar :menuselection:`Open Containing Folder`.
