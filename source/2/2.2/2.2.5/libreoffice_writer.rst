...
To toggle your view of rulers press :kbd:`Control + Shift +R` or :menuselection:`View --> Rulers --> Rulers`. To only toggle showing a veritcle ruler :menuselection:`View --> Rulers --> Verticle Rulers`. To toggle seeing formatting marks press :kbd:`Control + F10` or :menuselection:` View --> Formatting Marks`.
