...
The settings for removable media is able to be opened up is right click the applet Configure Removable media you can select show info, popup menu, or do nothing. If you want to reset the setting for this press the :guilabel:`Reset` button.
