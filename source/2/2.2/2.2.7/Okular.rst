...
When you fisrt open Okular you can open a file with the :guilabel:`Open Document` button, :menuselection:`File --> Open`, or press :kbd:`Control + O`. To relaod your file if something is changed press :kbd:`F5` or :menuselection:`File --> Reload`. To save a pdf :menuselection:`File --> Save` or press :kbd:`Control +S`.
