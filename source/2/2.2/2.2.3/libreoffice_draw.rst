...
To choose a pattern for your area press the :guilabel:`Pattern` button. To choose a preselected pattern left click under :guilabel:`Pattern` on it on the left hand side. To preview your pattern look at it under :guilabel:`Preview`. To change your foreground color of the pattern change :guilabel:`Foreground Color` field. To change the background color of your pattern change the :guilabel:`Background Color` field.
