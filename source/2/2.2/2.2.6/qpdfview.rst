...
If you want to reset these settings to the defaults is to press the :guilabel:`Defaults` button. To toggle having a small decoration showing where different pages are check the :guilabel:`Decorate links` checkbox. If you just want defaults on the current tab you can press the :guilabel:`Defaults on current tab` button. If you want to return to viewing your PDF with the same settings press the :guilabel:`OK` button. If you wish to discard your changes press the :guilabel:`Cancel` button.     
