...
To search for a word in a webpage press :kbd:`Control+F` and then type what you want to search for in the searchbar that pops up. To jump to the next result press the :guilabel:`Down arrow`.
