...
To lock your Screen :menuselection:`File --> Lock Screen Now`. If you want to kill the daemon :menuselection:`File --> Kill Daemon`. To restart the screensaver daemon :menuselection:`File --> Restart Daemon`. To make the screen blank :menuselection:`File --> Blank Screen Now`. To restart xscreensaver :menuselection:`File --> Restart Daemon`.  
