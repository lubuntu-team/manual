...
The left hand side has many symbols you can use for say set relations and other operators. If the symbol usually has a varibale or operand on on a side or something it will have a box to that side. To insert even more symbols :menuselection:`Tools --> Symbols`.
