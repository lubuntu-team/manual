...
To view a directory tree on your side pane select :menuselection:`directory tree` from the menu above the side pane. To expand into a folder press the :guilabel:`+` to expand the files and the :guilabel:`-` button to collapse the folder. To switch to back to places from the menu above the side pane select :menuselection:`Places`. 
