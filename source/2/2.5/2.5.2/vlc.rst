...
Webcams
------- 
To open your webcam in VLC press :kbd:`Control +C` or :menuselection:`Media --> Open Capture Device` to pop up a dialog to select your webcam. Then select your webcam in :guilabel:`Video device name` which can default to something like /dev/video0. To start showing your webcam click :guilabel:`Play`.
...
Version
-------
Lubuntu ships with version 3.0.21 of VLC.
