...
==========================================
Discover allows you to install and remove programs and utilities. It has a simplistic interface making it easy to navigate and use. Discover however does not support command line applications.
...
Version
-------
Lubuntu ships with version 6.6.91 of Discover.
